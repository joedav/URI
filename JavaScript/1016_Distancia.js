 ...
 * quilômetros do carro X, ou seja, consegue se afastar um quilômetro a cada 2 minutos.
...
const distanciaKM = parseInt(prompt());

function distancia(distKM) {

  const minutos = distKM * 2;
